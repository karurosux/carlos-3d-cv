...
export function DialogBox() {
  ...
  const typewriterCallback = useCallback(debounce(typewriter, 300), [
    textLine,
    textWrapper,
    typewriter,
  ])
  ...
  return (
    <>
      ...
      <span className='z-10 fixed bottom-4 animate-pulse select-none text-white left-4 text-2xl right-4 text-center'>
        Press <i className='ri-space' /> to continue.
      </span>
    </>
  )
